...
const SCREENS: Record<string, (busy: boolean, error: string | null) => JSX.Element> = {
  ...
  result: () => (
    <PaymentResult cart={CART} shippingAddress={ADDRESS} orderId="order_4303293I5YakNvkEWRosz" status="PAID" timedOut={false} polling={false} onCancelAndChangeMethod={noop} onRetry={noop} onBack={noop} />
  ),
  results: (busy) => (
