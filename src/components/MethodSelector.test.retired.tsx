/* eslint-disable */
// ─────────────────────────────────────────────────────────────────────────────
// Tests for the retired cashfree-here widget-tool dispatch.
//
// Commented out, not deleted, alongside the machinery they cover in
// MethodSelector.tsx. Each one records a measured host behaviour — the
// confirm-dispatch poll, the per-host retry counts, the anchor-vs-openLink
// split — that would be expensive to re-derive if this path is ever revived.
// ─────────────────────────────────────────────────────────────────────────────
